...
xgznode** toget_twodis(int** board,int mycolor,int color)
{
	...
	make_real(board,board1);
	if (mycolor == 1 && color == 1)//red
	{
		int** my_red_twodis_red = myred_toget_twodis_red(board1);
		redsort(my_red_twodis_red);
		xgznode** aim = new xgznode* [need];
	...
	{
		int** my_red_twodis_bule = myred_toget_twodis_bule(board1);
		redsort(my_red_twodis_bule);
		xgznode** aim = new xgznode * [need];
		for (int i = 0; i < need; i++)
		{
	...
	{
		int** my_bule_twodis_bule = mybule_toget_twodis_bule(board1);
		redsort(my_bule_twodis_bule);
		xgznode** aim = new xgznode * [need];
		for (int i = 0; i < need; i++)
		{
			aim[i] = &buleneedsort.back();
...
//	int redend = redneedsort.size() - 1;
//	int buleend = buleneedsort.size() - 1;
//	int redatt = 1;
//	int buleatt = 1;
//	while (1)
//	{
//		if (redneedsort[redend].distance != redmin)
//		{
//			break;
//		}
//		redend--;
...
//	while (1)
//	{
//		if (buleneedsort[buleend].distance != bulemin)
//		{
//			break;
//		}
//		buleend--;
...
//	}
//	int M = 100;
//	int pot = M * (redmin - bulemin) - (redatt - buleatt);
//	return pot;
//}
